  ...
  return (
    <div className="difference">
      <div className="difference-title">
        ...
        <p>
          Автоматизация — это проще, чем кажется. Мы создаем
          <br /> решения, которые работают с первого дня и не требуют
          <br /> специальных знаний.
        </p>
      </div>
      ...
      <div className="difference-info">
        <div>
          <h3>Просто</h3>
          <p>
            Внедряем готовые модули без сложных
            <br /> настроек и длительного обучения
          </p>
        </div>
        <div>
          <h3>Действенно</h3>
          <p>
            Каждое решение приносит измеримый
            <br /> результат и экономит ваши ресурсы
          </p>
        </div>
        <div>
          <h3>БЫСТРО</h3>
          <p>
            Первые работающие процессы
            <br /> запускаем уже через 24 часа после
            <br /> обращения
          </p>
        </div>
      </div>
